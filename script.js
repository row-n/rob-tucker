...
var Hero = function Hero(element, options) {
  _classCallCheck(this, Hero);

  var $element = (0, _jquery2.default)(element);
  var $mouse = document.getElementById('mouse');
  var splashOffset = (0, _jquery2.default)('.splash').offset().top;

  (0, _jquery2.default)(window).scroll(function () {
    var limit = $element.offset().top + $element.outerHeight();
    var scrollObject = {
    ...
    if (scrollObject.y > $element.offset().top && scrollObject.y <= limit) {
      var scrollOffset = (scrollObject.y - $element.offset().top) / 1.5;
  ...
  (0, _jquery2.default)($mouse).click(function (e) {
    e.preventDefault();
...
(0, _plugin2.default)('Hero', Hero);

},{"./plugin":5,"jquery":8}],3:[function(require,module,exports){
'use strict';
...
new _vanillaLazyload2.default(); // eslint-disable-line no-new

},{"vanilla-lazyload":10}],4:[function(require,module,exports){
'use strict';
...
var Menu = function Menu(element, options) {
  ...
  // };
  var $element = (0, _jquery2.default)(element);
  var $menu = this.$element.children('ul.menu__list');
  var $menuItems = $menu.find('li:not(.menu__item--back)').children('a');
  var $subMenu = $menu.find('ul.sub-menu');
  var $menuItemIndex = void 0;

  $subMenu.prepend('<li class="menu__item menu__item--back"><a href="#" class="menu__link">back</a></li>');

  var $back = $menu.find('li.menu__item--back').children('a');

  // const animEndEventName = `${animEndEventNames.animation}.menu`;

  Array.from($element.find('ul')).forEach(function (el) {
    var $menuList = el;
    $menuItemIndex = (0, _jquery2.default)($menuList).children('li').length;

    (0, _jquery2.default)($menuList).addClass('child-items-' + $menuItemIndex);
...
(0, _plugin2.default)('Menu', Menu);

},{"./plugin":5,"jquery":8}],5:[function(require,module,exports){
'use strict';
...
function plugin(pluginName, className) {
  ...
  _jquery2.default.fn[pluginName] = function pluginBuild(option) {
    var _this = this;
  ...
  _jquery2.default.fn[pluginName].noConflict = function () {
    return _jquery2.default.fn[pluginName];
  };
}
...
var ScrollToTop = function ScrollToTop(element, options) {
  _classCallCheck(this, ScrollToTop);

  var $element = (0, _jquery2.default)(element);

  (0, _jquery2.default)(window).scroll(function (event) {
    var scroll = (0, _debounce2.default)(function () {
      if ((0, _jquery2.default)(event.target).scrollTop() > options.offset) {
...
(0, _plugin2.default)('ScrollToTop', ScrollToTop);

},{"./debounce":1,"./plugin":5,"jquery":8}],7:[function(require,module,exports){
'use strict';
...
(0, _jquery2.default)('#trigger').click(function () {
  return (0, _jquery2.default)('body').toggleClass('menu-open');
});

(0, _jquery2.default)('#menu').Menu();
(0, _jquery2.default)('#hero').Hero();
(0, _jquery2.default)('#scroll-to-top').ScrollToTop();

},{"./plugins/hero":2,"./plugins/lazy-load":3,"./plugins/menu":4,"./plugins/to-top":6,"jquery":8,"pace-progress":9}],8:[function(require,module,exports){
/*!
