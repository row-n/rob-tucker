...
var Menu = function Menu(element, options) {
  ...
  // };
  var $element = (0, _jquery2.default)(element);
  var $menu = $element.children('ul.menu__list');
  ...
  (0, _jquery2.default)('.menu-item-has-children').children('a').on('click', function (event) {
    // prevent default clicking on direct children of .has-children
    event.preventDefault();
    var selected = (0, _jquery2.default)(event.target);
    console.log(selected.next('ul'));
    selected.next('ul').removeClass('is-hidden').end().parent('.menu-item-has-children').parent('ul').addClass('animate-out');
  });
