<?php
	...
	function rob_tucker_menu() {

		$j = wp_get_nav_menu_items( 2 );
		...
		foreach( $j as $link ) {
			...
			?><li <?php if (strtolower( $link->title ) == 'works' ) echo ' class="works-item" '; ?>><a href="<?php echo $link->url ?>"><?php echo $link->title ?></a></li><?php
		}
