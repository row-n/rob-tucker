...
<head>
	...
	<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_url' ); ?>/less/jquery.sidr.light.css">
...
<div id="main"><!-- this encompasses the entire Web site -->
	...
	<?php if( is_front_page() || is_404() ) { ?>
		<?php if ( has_post_thumbnail() ) {
			...
			echo '<div id="home-image" class="container"><img src="' . $full_image_url[0] . '"></div>';
		} ?>
	<?php } ?>
	...
	<div class="header">
		...
		<a href="#sidr-right" class="handle">
			<!-- &#8801; -->
			<div class="line1"></div>
			<div class="line2"></div>
			<div class="line3"></div>
